    ...
    <div css={styles.section}>
      <div css={styles.header}>
        <div css={styles.pillBadge}>
          ...
          PLACED ALUMNI SUCCESS STORIES
        </div>
        <h2 css={styles.heading}>{data.title || "Real Candidate Placement Stories"}</h2>
        <p css={styles.subtitle}>See how freshers and experienced candidates launched their careers through UDEN.</p>
      </div>
        ...
        <div css={styles.authorRow}>
          <div css={styles.authorInfo}>
            ...
            <div>
              ...
              <div css={styles.authorRole}>UDEN Placed Candidate</div>
            </div>
          </div>

          <div css={styles.verifiedBadge}>
            <Award size={15} />
            Verified Placed Alumni
          </div>
        </div>
      </div>
