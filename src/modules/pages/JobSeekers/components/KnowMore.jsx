      ...
      <div css={styles.banner}>
        <div>
          ...
          <h2 css={styles.heading}>
            Ready to Land Your <span>Dream Tech Job?</span>
          </h2>
          <p css={styles.subtitle}>Get pre-assessed, matched with verified recruiters, and get hired within 14 days.</p>
        </div>
