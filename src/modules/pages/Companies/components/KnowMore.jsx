      ...
      <div css={styles.banner}>
        <div>
          ...
          <h2 css={styles.heading}>
            Access Top Tech Talent & Build Your <span>Dream Team with Ease</span>
          </h2>
          <p css={styles.subtitle}>Let UDEN find the right candidate fit for your engineering requirements within 48 hours.</p>
        </div>
