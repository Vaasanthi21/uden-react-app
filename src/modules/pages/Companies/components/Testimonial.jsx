  ...
  return (
    <div css={styles.section}>
      <div css={styles.header}>
        ...
        <h2 css={styles.heading}>{data.title || "Trusted by Corporate Talent Managers"}</h2>
        <p css={styles.subtitle}>See how hiring leads and HR managers scale their engineering teams using UDEN.</p>
      </div>
