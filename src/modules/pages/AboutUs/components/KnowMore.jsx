      ...
      <div css={styles.banner}>
        <div>
          ...
          <h2 css={styles.heading}>
            Join UDEN in Shaping the <span>Future of Tech Hiring</span>
          </h2>
          <p css={styles.subtitle}>Connect with our team to explore hiring, partnership, or upskilling opportunities today.</p>
        </div>

        <button 
          css={styles.ctaBtn}
          onClick={() => navigate(AppRoutes.COTACT_US)}
        >
          Contact Our Team
          <ArrowRight size={18} />
        </button>
