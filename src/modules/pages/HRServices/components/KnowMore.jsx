      ...
      <div css={styles.banner}>
        <div>
          ...
          <h2 css={styles.heading}>
            Join the HR Revolution with UDEN — <span>Elevate Your Business Today</span>
          </h2>
          <p css={styles.subtitle}>Partner with UDEN to unleash the full potential of your talent and streamline your workplace operations.</p>
        </div>
