      ...
      <Card css={AboutUsStyles} >
        ...
        <CardContent className='founder-card-content'>
          <Grid container justifyContent='center' alignItems='center'>
            <Grid item>
              <Typography className='founder-card-name' variant="h6">{data.name}</Typography>
            </Grid>
            <Grid item>
          ...
          <Typography className='founder-card-designation' variant='caption' component="p">{data.designation}</Typography>
