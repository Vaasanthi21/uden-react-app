...
const map = {
  ...
  11: 'media__1785403745181.png',
  12: 'media__1785403906138.png',
  13: 'media__1785404343319.png',
  14: 'media__1785404386019.png',
  15: 'media__1785404634249.png',
  ...
  25: 'media__1785396350976.png',
  26: 'media__1785396350976.png',
  27: 'media__1785407350028.jpg',
  28: 'media__1785402706599.png',
  29: 'media__1785403488759.png',
  30: 'media__1785401384436.png',
  31: 'media__1785402537082.png',
  32: 'media__1785402471439.png',
  33: 'media__1785406323122.png',
...
function generateDoc(outputPath, useBase64) {
...
<div class="meta-box">
  <p class="field-p"><span class="field-label">Document Title:</span> Engineering QA Handover &amp; Defect Document</p>
  ...
  <p class="field-p"><span class="field-label">Total Test Suite Cases:</span> 34 Executed Test Cases (23 Verifications, 11 Active Defects)</p>
  ...
  <p class="field-p"><span class="field-label">Date &amp; Timestamp:</span> July 30, 2026 • 16:59 IST</p>
</div>
...
<h2>2. Comprehensive Test Cases &amp; Visual Evidence (34 Items)</h2>
`;
...
<div class="test-section">
  ...
  <div class="screenshot-box">
    <p class="field-label">Evidence Screenshot:</p>
...
try {
  generateDoc(path.join(__dirname, 'public/Vasanthi_Engineering_QA_Handover_Report_30_Jul_2026.doc'), true);
  generateDoc(path.join(__dirname, 'public/Vasanthi_Engineering_QA_Handover_Report_v2_30_Jul_2026.doc'), true);
  generateDoc(path.join(__dirname, 'public/Vasanthi_Engineering_QA_Handover_Report_v3_30_Jul_2026.doc'), true);
} catch (e) {
  console.error(e);
}
